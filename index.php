        ...
        <div class="modal-content">
          ...
          <div id="Logar" class="tab">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title"><span id="icon-login" class="glyphicon glyphicon-user" style="padding-right: 8px"></span>Efetuar Login</h4>
            ...
            <div class="modal-body div-login">
                <div id="div-info" class="col-md-6">
                    ...
                    <p>Quais as vantagens de possuir uma conta?</p>
                    <ul>
                        <li>Se inscrever em atividades.</li>
                        <li>Receber e-mails com novidades de atividades e novos eventos.</li>
                    </ul>
                </div>
                <div class="col-md-6" style="margin-bottom: 5px;">
                    <div class="form-group">
                        <label for="email"><span id="icon-email-pass" class="glyphicon glyphicon-envelope"></span> E-mail</label>
...
<footer>
  <div class="col-lg-12 rodape">
    <div id="nupsi-footer" class="col-xs-6">
      <h3>NUPSI Contato</h3>
      <p>Av. Professor Mário Palmerio, 1001 - Bairro Universitário - Frutal/MG
         CEP: 38200-000 - Telefone (34) 3423-2700 - Ramal 2772</p>
      <p>E-mail: nuspi.frutal@uemg.br</p>
        <img id="img-nupsi" src="imagens/NUPSI.png">
    </div>
    <div class="col-xs-6" id="uemg-footer">
      <h3>UEMG Contato</h3>
